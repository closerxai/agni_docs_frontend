...
<Steps>
  <Step title="Create your account" icon="user-plus">
    Contact [support@ravan.ai](mailto:support@ravan.ai) to get started with Google or email. Your workspace is ready instantly.
  </Step>
...
<Card title="Usage-Based Pricing" icon="money-bill-wave">
  **Simple. Transparent. No hidden fees.** Contact our sales team for a custom pricing plan tailored to your volume and use case.
</Card>

<Card title="Talk to Sales" icon="phone" href="mailto:support@ravan.ai">
  Reach out to our team for pricing details, volume discounts, and enterprise plans.
</Card>
