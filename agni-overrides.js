...
// Suppress noisy Mintlify socket.io errors (cosmetic only)
...
// NOTE: Do NOT wrap window.fetch or XMLHttpRequest — it breaks Mintlify's
// built-in API playground on static exports (causes "t.0 is not a function").

// Block socket.io via Ctrl+K intercept only (no fetch/XHR wrapping)
(function () {
})();
