...
<CardGroup cols={3}>
  ...
  <Card title="Total Minutes" icon="stopwatch">
    The aggregate number of voice minutes consumed. At $0.07/min, multiply this by 0.07 to get your cost.
  </Card>
...
<CardGroup cols={2}>
  <Card title="Usage Trend" icon="chart-line">
    Tracks calls and minutes over time. Because Agni operates on a usage-based pricing model, this chart directly correlates to your platform spend. Look for unexpected spikes or drops.
  </Card>
