...
The **Billing** page is where you manage the financial aspects of your Agni workspace. Agni operates on a usage-based infrastructure, and your billing is managed through a combination of your baseline subscription and your prepaid credit balance. [Contact sales](mailto:support@ravan.ai) for pricing details.
...
<CardGroup cols={3}>
  <Card title="Usage-Based" icon="clock">
...
<Card title="Get Pricing" icon="envelope" href="mailto:support@ravan.ai">
...
Manage your platform access and subscription.
