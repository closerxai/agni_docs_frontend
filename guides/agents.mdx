...
The **Agents** dashboard is where you design the core intelligence of your voice infrastructure. An Agni agent is more than just a prompt—it is a fully configurable voice persona with customizable speech patterns, tool access, and call-handling behaviors.
...
You can inject **Dynamic Variables** into your prompt using double curly braces (e.g., {{user_name}} or {{company}}). During live calls, you can pass values into these variables via the API to personalize the conversation. When testing your agent in the dashboard, any variables you define will automatically generate an input field in the testing panel so you can simulate dynamic data.
